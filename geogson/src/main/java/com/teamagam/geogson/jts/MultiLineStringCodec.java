...
public class MultiLineStringCodec
    extends AbstractJtsCodec<com.vividsolutions.jts.geom.MultiLineString, MultiLineString> {
  ...
  public com.vividsolutions.jts.geom.MultiLineString fromGeometry(MultiLineString src) {
    return this.geometryFactory.createMultiLineString(FluentIterable.from(src.lineStrings())
