...
@AutoFactory
public class AdvancedSettingsRangeTimeplayInteractor extends TimeplayInteractor {

  private static final int DISPLAY_INTERVAL_MILLIS = 100;

  public AdvancedSettingsRangeTimeplayInteractor(@Provided ThreadExecutor threadExecutor,
