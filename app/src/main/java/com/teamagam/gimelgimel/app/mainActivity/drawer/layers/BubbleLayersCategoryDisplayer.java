...
@AutoFactory
public class BubbleLayersCategoryDisplayer extends VectorLayersCategoryPresenter {

  private final Context mContext;

  protected BubbleLayersCategoryDisplayer(@Provided
  ...
  protected String getCategoryTitle() {
    return mContext.getString(R.string.drawer_layers_category_name_bubble_layers);
  }
}
