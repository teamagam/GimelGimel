...
public class LoggerFactory {
  ...
  public static void initialize(Factory loggerFactory) {
    if (isInitialized()) {
      throw new RuntimeException(
          LoggerFactory.class.getSimpleName() + " cannot be initialized more than once");
    }
  ...
  public static Logger create(String tag) {
    if (!isInitialized()) {
      throw new RuntimeException(LoggerFactory.class.getSimpleName() + " has not been initialized");
    }
