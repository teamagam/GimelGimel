...
public class MultiPolygonCodec
    extends AbstractJtsCodec<com.vividsolutions.jts.geom.MultiPolygon, MultiPolygon> {
  ...
  public com.vividsolutions.jts.geom.MultiPolygon fromGeometry(MultiPolygon src) {
    return this.geometryFactory.createMultiPolygon(FluentIterable.from(src.polygons())
