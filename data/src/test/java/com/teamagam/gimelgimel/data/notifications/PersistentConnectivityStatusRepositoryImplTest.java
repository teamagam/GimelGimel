...
public class PersistentConnectivityStatusRepositoryImplTest extends BaseTest {
    ...
    public static final long NOT_ENOUGH = TIMEOUT_MILLIS - BUFFER;
    public static final long ENOUGH = TIMEOUT_MILLIS + BUFFER;
    public static final long MORE = ENOUGH - NOT_ENOUGH;
    ...
    @Before
    public void setUp() {
        mStatusRepo = new PersistentConnectivityStatusRepositoryImpl(
                ConnectivityStatus.CONNECTED, TIMEOUT_MILLIS);
