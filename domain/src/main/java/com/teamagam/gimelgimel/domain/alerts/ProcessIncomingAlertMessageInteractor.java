...
public class ProcessIncomingAlertMessageInteractor extends BaseDataInteractor {
   ...
   */
  private final com.teamagam.gimelgimel.domain.messages.AddPolledMessageToRepositoryInteractorFactory
  ...
  public ProcessIncomingAlertMessageInteractor(@Provided ThreadExecutor threadExecutor,
      ...
      @Provided
          com.teamagam.gimelgimel.domain.map.DrawEntityOnMapInteractorFactory drawEntityOnMapInteractorFactory,
