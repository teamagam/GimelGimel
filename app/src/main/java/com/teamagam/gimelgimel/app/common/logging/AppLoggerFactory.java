...
public class AppLoggerFactory {
  ...
  private static String getClassSimpleName() {
    ...
    return callingClassFullName.substring(callingClassFullName.lastIndexOf(".") + 1);
  }
  ...
  private static void setupDiskLoggerConfigurations(ExternalDirProvider externalDirProvider) {
    ...
    configureLogger(sExternalStorageLogDirectoryPath, Constants.LOG_FILE_NAME_SUFFIX,
        Constants.MAX_LOG_SIZE, Constants.MAX_BACKUP_LOG_FILES);
  }
  ...
  private static AppLogger createLog4jLogger(String tag) {
    ...
    VerbosityFilterLoggerDecorator verbosityFilteredLogger =
        new VerbosityFilterLoggerDecorator(log4jLogger, configuration);
