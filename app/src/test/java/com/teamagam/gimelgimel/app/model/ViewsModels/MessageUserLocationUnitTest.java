...
/**
 * Tester for {@link MessageUserLocationApp}
 */
...
public class MessageUserLocationUnitTest {
    ...
    public void check_correct_Creation_JSON() throws Exception {
        PointGeometryApp p = new PointGeometryApp(32.2, 23.1);
...
//        assertEquals("JSON of MessageUserLocationData was not generated properly ",expected_JSON, result_JSON);
//
//        the retrofit does some black magic in converting json back to MessageApp Object.
        MessageApp resultMSG = gson.fromJson(expected_JSON, msg.getClass());
        assertEquals("MessageUserLocationData was not generated properly from JSON",msg.getMessageId(), resultMSG.getMessageId());
    }
}