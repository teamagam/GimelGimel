...
/**
 * A couple of coordinates on the X and Y axis. If your map is in a geographic projection they will
 * be Longitute and
 * Latitude.
 *
 * eg:
...
public class Coordinates implements Serializable {
   ...
   *
   * @param lon longitude, x-axis coordinate, see {@link Coordinates#lon lon}
   * @param lat latitude, y-axis coordinate, see {@link Coordinates#lat lat}
   ...
   * @param lon longitude, x-axis coordinate, see {@link Coordinates#lon lon}
   * @param lat latitude, y-axis coordinate, see {@link Coordinates#lat lat}
   * @param alt altitude, z-axis coordinate, see {@link Coordinates#alt alt}
  ...
  public boolean equals(Object obj) {
    if (this == obj) {
      ...
      return Objects.equal(this.lon, other.lon)
          && Objects.equal(this.lat, other.lat)
          && Objects.equal(this.alt, other.alt);
    }
  }
