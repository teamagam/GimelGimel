...
public class Feature {
   ...
   *
   * @return an ImmutableMap containing the properties. An empty map if not properties have been
   * set.
   */
  ...
  public Feature withProperty(String name, JsonElement value) {
    return new Feature(geometry,
        ImmutableMap.<String, JsonElement>builder().putAll(properties).put(name, value).build(),
        id);
  }
