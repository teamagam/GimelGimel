...
public class KmlBalloonDataParserTest {
    ...
    private static String SAMPLE_KML_BALLOON_STYLE_FORMATTED =
            "<html>" + NEW_LINE +
                    "<body>" + NEW_LINE +
                    "<table border=\"2\" cols=\"2\" width=\"100%\">" + NEW_LINE +
                    "<tr>" + NEW_LINE +
                    "<td> <center>" + NEW_LINE +
                    "category" + NEW_LINE +
                    "</center> </td>" + NEW_LINE +
    ...
    public void setUp() throws Exception {
        mKmlBalloonDataParser = new KmlBalloonDataParser(
                SAMPLE_KML_BALLOON_STYLE_FORMATTED);
    }
