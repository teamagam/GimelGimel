...
public class LinearRing extends LineString {
   ...
   *
   * @param points Point sequence composed at least by 4 points, with the first and the last that
   * are the same.
   * @return a LinearRing
   */
   ...
   * Create a LinearRing from the given points.
   *
   * @param points Point Iterable composed at least by 4 points, with the first and the last that
   * are the same.
   * @return a LinearRing
   */
