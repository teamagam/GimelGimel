 ...
 */
@AutoFactory
public class SyncMessagesInteractor extends SyncInteractor<Message> {

    private final MessagesRepository mMessagesRepository;

    SyncMessagesInteractor(@Provided ThreadExecutor threadExecutor,
    ...
    protected Observable<Message> buildUseCaseObservable() {
        return mMessagesRepository.getSyncMessagesObservable();
    }
}
