...
/**
 * This entity is a "friends" entity from GGMessagingApi
 ...
 */
public class FriendsEntity implements Serializable, DbEntity, ProviderEntity {
     ...
     */
    public FriendsEntity(Cursor cursor) {
    ...
    public void initWithPreviousValuesFromProvider(ContentResolver provider) {
        ...
        try {
            favoriteQuery = provider.query(FriendsEntity.CONTENT_URI,
                    new String[]{FriendsEntity.DB.IS_FAVORITE},
                    FriendsEntity.DB.ID + "=?",
                    new String[]{id},
                    null);
