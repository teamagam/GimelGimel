...
class VerbosityConfiguration {
  ...
  @IntDef({
      VerbosityLevel.DEBUG, VerbosityLevel.ERROR, VerbosityLevel.INFO, VerbosityLevel.VERBOSE,
      VerbosityLevel.WARNING, VerbosityLevel.USER_INTERACTION, VerbosityLevel.LIFECYCLE
  })
