...
public class SinglePosition extends AbstractPositions<Positions> {
  ...
  /**
   * Merge this SinglePosition with another {@link Positions} instance. If the given {@link
   * Positions} is:
   * - a SinglePosition, it returns a {@link LinearPositions} composed by this and the given
   * positions, in order.
