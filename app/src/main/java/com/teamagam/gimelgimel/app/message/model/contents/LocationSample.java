 ...
 * <p/>
 * <p>A location can consist of a {@link PointGeometryApp} , timestamp,
...
public class LocationSample implements Parcelable {
     ...
     */
    public LocationSample(PointGeometryApp point, long time) {
        mPoint = point;
        mTime = time;
    }
    ...
    public LocationSample(Location l) {
        ...
        mTime = l.getTime();
        mPoint = new PointGeometryApp(l.getLatitude(), l.getLongitude());
        if (l.hasAltitude()) {
    ...
    protected LocationSample(Parcel in) {
        mPoint = in.readParcelable(PointGeometryApp.class.getClassLoader());
        mTime = in.readLong();
